  ...
  return (
    <nav className="bg-slate-800 text-slate-100 px-4 py-6 shadow flex justify-between items-center h-14">
      ...
      <div className="space-x-6 text-lg flex items-center">
        ...
        >
          <span className="material-icons text-blue-300 transition-colors duration-300">home</span>
          ホーム
        </Link>
        <Link
          to="/survey"
        ...
        >
          <span className="material-icons text-purple-300 transition-colors duration-300">assignment</span>
          アンケート
        </Link>
        <Link
          to="/result"
        ...
        >
          <span className="material-icons text-green-300 transition-colors duration-300">check_circle</span>
          結果
        </Link>
      </div>
    </nav>
